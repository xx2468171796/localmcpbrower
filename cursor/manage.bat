...
title Cursor MCP 服务管理 [Browser + Database]

:menu
cls
echo.
echo  ====================================================
echo    Cursor MCP 服务管理 [Browser %BROWSER_PORT% + Database %DB_PORT%]
echo  ====================================================
echo.
