...
title Windsurf MCP Bridge Manager
cd /d "%~dp0"
...
cd /d "%~dp0"
call pm2 delete windsurf-mcp-bridge >nul 2>&1
...
call pm2 delete windsurf-mcp-database >nul 2>&1
call pm2 start ecosystem.config.cjs
if errorlevel 1 (
...
echo ========================================
echo.
call pm2 stop windsurf-mcp-bridge >nul 2>&1
call pm2 delete windsurf-mcp-bridge >nul 2>&1
echo [OK] windsurf-mcp-bridge killed.
call pm2 stop windsurf-mcp-database >nul 2>&1
call pm2 delete windsurf-mcp-database >nul 2>&1
...
cls
echo ========================================
echo   Windsurf MCP Status - %date% %time%
echo ========================================
echo.
echo [PM2 Processes]
call pm2 list 2>nul
...
echo ========================================
echo.
call pm2 logs windsurf-mcp-bridge --lines 50 --nostream 2>nul
echo.
echo Press any key to continue...
pause >nul
goto menu
...
echo ========================================
echo.
call pm2 logs windsurf-mcp-database --lines 50 --nostream 2>nul
echo.
echo Press any key to continue...
pause >nul
goto menu
...
echo   C:\Users\USERNAME\.codeium\windsurf\mcp_config.json
echo.
echo Config content:
echo.
echo {
...
set "MCP_DIR=%USERPROFILE%\.codeium\windsurf"
