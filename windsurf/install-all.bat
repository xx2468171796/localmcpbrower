@echo off
title Windsurf MCP - Full Installation
cd /d "%~dp0"

echo ========================================
echo   Windsurf MCP - Full Installation
...
echo {
echo   "mcpServers": {
echo     "stable-browser": { "serverUrl": "http://localhost:3211/mcp" },
echo     "database": { "serverUrl": "http://localhost:3212/mcp" }
echo   }
echo }
echo.
pause
